<!-- MODAL SHOW -->                                                             
<div class="modal fade" id="modalShowHistorico-{{$veiculo->id}}" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="list-group">                    
                    ...
                    <li class="list-group-item"><b>Entrada de saída:</b> {{ date('d/m/Y H:i:s', strtotime($veiculo->saida)) }} </li>
